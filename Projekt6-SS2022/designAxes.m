function designAxes(app)
    ...
    if app.BeschlVerlaufCheckBox.Value
        if mod(cnt,2) == 0
            app.accUIAxes.Layout.Row = cnt / 2 + 1;
            app.accUIAxes.Layout.Column = 2;
        else
            app.accUIAxes.Layout.Row = round(cnt/2) + 1;
    ...
    switch (cnt - 1)
        case 1
            ...
            app.GridLayoutLeft.RowHeight = {'0.2x', '1x', '0x'};
        ...
        case 3
            ...
            app.GridLayoutLeft.RowHeight = {'0.2x', '1x', '1x'};
            app.GridLayoutLeft.ColumnWidth = {'1x', '1x'};
        case 4
